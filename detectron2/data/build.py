...
def get_detection_dataset_dicts(
    ...
    if isinstance(dataset_dicts[0], torchdata.Dataset): # False
    ...
    has_instances = "ann_infos" in dataset_dicts[0] # False
...
def _train_loader_from_config(cfg, mapper=None, *, dataset=None, sampler=None,datapkl=None):
    if dataset is None:
